...
10. Which of the steps could be omitted?
        ...
        Any involving the "git status" command.

11. Why might it be a bad idea to omit them?

        They tell you the current status of your working directory. Not knowing the current status can lead to unfortunate things, such as deleting files that have yet to be committed to the repository.
